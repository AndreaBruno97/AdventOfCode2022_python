...
class Node:
    ...
    def is_adjacent(self, node):
        ...
        return horizontal_distance + vertical_distance <= 1 and node.altitude <= self.altitude + 1
...
class Part_1(BaseClass):
    ...
    def execute_internal(self, filepath):
        ...
        while len(temporary) > 0:
            ...
            if new_permanent.compare_point(end_point):
                # End point found
                break
